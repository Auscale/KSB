<?php
  ...
  if(isset($_SESSION['user_id'])){
    header('location:view_subs.html');
  }
?>
<!doctype html>
<html>
  ...
  <body class="preload">
    <div id="wrapper">
      ...
      <div id="page">
        <div id="form_wrap">
          <form id="register_form" method="post" action="scripts/sign_in_script.php">
            <label for="reg_username">Username:</label>
            <input type="text" id="reg_username" name="username" required autofocus>
            <label for="reg_password">Password:</label>
            <input type="password" id="reg_password" name="password" required>
            <input type="submit" class="reg_submit" value="Sign In">
          </form>
        </div>
      </div>
    </div>
